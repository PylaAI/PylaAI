...
const SETTINGS_META = {
    ...
    webhook: [
        { key: "discord_bot_enabled", label: "Discord Bot", type: "checkbox", help: "Load Discord remote-control features on the next full restart. When disabled, discord.py is not loaded into memory." },
        ...
        { key: "discord_bot_token", label: "Discord Bot Token", type: "password", visibleIf: { key: "discord_bot_enabled", value: true }, help: "Discord bot token used for remote control commands. Requires full restart to apply." },
        ...
        { key: "discord_guild_id", label: "Discord Guild ID", type: "text", visibleIf: { key: "discord_bot_enabled", value: true }, help: "Discord server ID where slash commands should be synced." },
